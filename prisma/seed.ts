import { PrismaClient, TransactionType, SavingsTransactionType, PaymentFrequency } from '@prisma/client';
...
async function main() {
  ...
  const user = await prisma.user.upsert({
    where: { email: 'demo@kampuscuan.com' },
    update: {},
    create: {
      name: 'Adrian Wijaya',
      email: 'demo@kampuscuan.com',
      passwordHash,
  ...
  const transactions = await Promise.all([
    ...
    prisma.transaction.create({
      data: {
        ...
        description: 'Project design logo UMKM',
      },
    }),
    // Expenses
    prisma.transaction.create({
      data: {
        ...
        paymentMethod: 'E-WALLET',
        description: 'Warmindo Abadi',
        notes: 'Nasi goreng + es teh',
        isAutoCateg: true,
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        category: 'Makanan & Minuman',
        paymentMethod: 'CASH',
        description: 'Kopi Kenangan Sunset',
        notes: 'Americano + Croissant',
      },
    }),
    prisma.transaction.create({
      data: {
    ...
    prisma.transaction.create({
      data: {
        ...
        category: 'Pendidikan',
        paymentMethod: 'BANK',
        description: 'Beli buku Algoritma Cormen',
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        amount: 100000,
        category: 'Hiburan & Lifestyle',
        paymentMethod: 'E-WALLET',
        description: 'Nonton Bioskop XXI',
        notes: 'Film Marvel baru',
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        category: 'Belanja',
        paymentMethod: 'E-WALLET',
        description: 'Shopee - Case HP + Charger',
      },
    }),
    prisma.transaction.create({
      data: {
    ...
    prisma.transaction.create({
      data: {
        ...
        category: 'Makanan & Minuman',
        paymentMethod: 'CASH',
        description: 'Indomie Goreng double + telur',
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        category: 'Kesehatan',
        paymentMethod: 'BANK',
        description: 'Konsultasi dokter gigi',
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        category: 'Makanan & Minuman',
        paymentMethod: 'E-WALLET',
        description: 'Dinner Yoshinoya',
        notes: 'Berdua bareng temen',
      },
    }),
    prisma.transaction.create({
      data: {
        ...
        category: 'Transportasi',
        paymentMethod: 'E-WALLET',
        description: 'Gojek pulang malam',
      },
    }),
  ]);
